...
<div class="row">
       ...
       <h6 class="text-light"> For Tantra</h6>
       <div class="card p-3">
            <form method="post" action="tantras.php" enctype="multipart/form-data">
...
$con = mysqli_connect("localhost","future","hta123","i6834132_wp1");
   $query=mysqli_query($con,"select * from tantra");
