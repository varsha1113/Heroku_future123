...
<html lang="en">
         ...
         <div class="con-pnl">
             <div class="container pt-5">
                 <div class="row">
                     ...
                     <div class="row">
   <div class="col-12  p-2 mb-4 mt-3" style="background-color: #DEB65E;">
       <h6 class="text-light">Monthly Horoscope </h6>
   <div class="card p-3">

                <form method="post" action="horscope.php" enctype="multipart/form-data">
                <input type="file" name="image"><br>
                <textarea class="w-100 mt-2" name="title" placeholder="title here" style="height: 30px;"></textarea><br>
 ...
 <div class="col-12 p-2 mb-4 mt-3 " style="background-color: #DEB65E;">
<h6 class="text-light"> Monthly Horoscope </h6>
<div class="card p-3" style="height: 260px;overflow-y:auto;">
...
$con = mysqli_connect("localhost","future","hta123","i6834132_wp1");
   ...
   while($row=mysqli_fetch_array($query)){
       ...
       <tr>
            <td><?php echo $id ;?></td>
           <td><img src="images/<?php echo $image ;?>" style="width:100px;height:50px;"></td>
           <td style="width: 250px;"><div style="width: 100%;height:60px;overflow:hidden;"><?php echo $title ;?></div></td>
           <td><a href="delete.php?id=<?php echo $row['id']; ?>"><button type="submit" class="btn btn-danger">Delete</button></a></td>
       </tr>
       <?php }?>
   </table>
...
<div class="row">
            <div class="col-12">
                 <a href='https://www.horando.de/en/'>Buy your watch</a> <script type='text/javascript' src='https://www.freevisitorcounters.com/auth.php?id=516d4483640d0a267bda8561a10f53452a73b834'></script>
<script type="text/javascript" src="https://www.freevisitorcounters.com/en/home/counter/788547/t/6"></script>
            </div>
        </div>
