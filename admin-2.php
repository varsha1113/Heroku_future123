...
<html lang="en">
  <head>
    ...
    <style>
       ...
       .sidebar{width: 250px; background-color: #6E4C1E;height: 100vh;position: absolute;}
 ...
 <section>
   ...
   <div class="row">
       <div class="col-5  p-2 mb-4" style="background-color: #DEB65E;">
       <h6 class="text-light"> For Gallery</h6>
       <div class="card p-3" style="height: 220px;overflow-y:auto;">
            <form method="post" action="gallery-a.php" enctype="multipart/form-data">
       ...
       <div class="col-7  p-2 mb-4" style="background-color: #DEB65E;">
       <h6 class="text-light"> Gallery List</h6>
           <div class="card p-3" style="height: 220px;overflow-y:auto;">
           <?php
...
<table>
       <tr>
           ...
           <td><img src="images/<?php echo $image ;?>" style="width:200px;height:150px;"></td>
         
           <td style="width: 70px;"><a href="delete3.php?id=<?php echo $row['id']; ?>"><button type="submit" class="btn btn-danger">Delete</button></a></td>
       </tr>
   </table>
   <?php }?>
           </div>
