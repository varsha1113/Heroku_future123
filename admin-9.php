     ...
     <div class="row" style="position: relative;">
         <div class="sidebar"  >
             ...
             <button type="button" class="btn btn-secondary w-100 mt-3">Achook Upay</button><br></a>
              <a href="admin-7.php">
             <button type="button" class="btn btn-secondary w-100 mt-3">रावण संहिता </button><br></a>
             </div>
             </div>
         </div>
         <div class="con-pnl">
...
<div class="row">
       ...
       <h6 class="text-light">रावण संहिता </h6>
       <div class="card p-3">
            <form method="post" action="ravans.php" enctype="multipart/form-data">
...
$con = mysqli_connect("localhost","future","hta123","i6834132_wp1");
   ...
   while($row=mysqli_fetch_array($query)){
       ...
       <tr>
           ...
           <td ><div style="width: 100%;height:60px;  overflow:hidden;"><img src="images/<?php echo $image ;?>" style="width:100px;height:50px;"></div></td>
           <td style="width: 70px;"><a href="delete4.php?id=<?php echo $row['id']; ?>"><button type="submit" class="btn btn-danger">Delete</button></a></td>
       </tr>
       <?php }?>
   </table>
